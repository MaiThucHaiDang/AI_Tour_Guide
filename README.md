# Đồ án AI Tour Guide - Tính Năng 1 (Frontend)

Chào mừng bạn đến với mã nguồn Frontend cho **Tính năng 1: Quét ảnh -> Nhận diện -> Thuyết minh bằng giọng nói** của đồ án AI Tour Guide. 

Dự án này được thiết kế và xây dựng dưới dạng **Mobile Web App** (Ứng dụng Web dành cho thiết bị di động) bằng **ReactJS (Vite)**, cho phép chạy mượt mà trên cả trình duyệt máy tính và điện thoại.
...
2. Chọn `File` > `Open Folder...` và chọn thư mục `AI Tour Guide`.
...
3. Chạy lại server với lệnh:
   ...
   npm run dev -- --host
   ```
4. Terminal sẽ hiện thêm đường link **Network**, ví dụ: `http://192.168.1.5:5173/`.
5. Lấy điện thoại mở Safari/Chrome và gõ đúng đường link Network đó vào. Cấp quyền Camera và trải nghiệm!
...
File `.gitignore` đã được setup đầy đủ, bạn chỉ cần gõ 3 lệnh sau để đưa code lên nhánh của mình:

```bash
git add .
git commit -m "feat: Hoan thanh UI/UX va Logic cho Tinh nang 1"
git push origin main
```
*(Thay `main` bằng tên nhánh của bạn nếu có).*

Chúc nhóm hoàn thành xuất sắc đồ án! 🎉
