...
const DEST_IMAGES = ['/assets/images/art_16_1.jpg', '/assets/images/art_16_2.jpg'];

const DienLongAnCheckout = ({ language, destination, onBack }) => {
  ...
  return (
    <div className="payment-page">
      <header className="payment-header">
        ...
        <span>{isVi ? 'Điện Long An - Mua vé tham quan' : 'Dien Long An - Buy tickets'}</span>
      </header>

      <div className="payment-hero">
        <img src={DEST_IMAGES[0]} alt="Điện Long An" className="payment-hero-img" />
        <div className="payment-hero-overlay">
          <h1 className="payment-hero-title">Điện Long An</h1>
          <p className="payment-hero-sub">
            {isVi ? 'Bảo tàng Cổ vật Cung đình Huế' : 'Hue Royal Antiquities Museum'}
          </p>
      ...
      <main className="payment-main">
        ...
        <div className="payment-card">
          ...
          <p className="payment-card-subtitle">
            {isVi
              ? 'Chọn vé, đồ ăn và thông tin để hoàn tất thanh toán một cách an toàn.'
              : 'Select tickets, food and your details to complete the payment safely.'}
          </p>
          ...
          <form ref={formRef} id="checkout-form" onSubmit={handleSubmit} className="payment-form">
            <div className="payment-row">
              ...
              <div className="payment-field">
                ...
                <small className="payment-note-text">{isVi ? 'Miễn phí (dưới 12 tuổi)' : 'Free (under 12)'}</small>
              </div>
            </div>
...
export default DienLongAnCheckout;
