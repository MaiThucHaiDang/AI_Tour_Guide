...
def main():
    ...
    for x in enriched_results:
        if x["name_vi"] == "Ngọ Môn":
            print("Ngọ Môn is already enriched. Exiting.")
            sys.exit(0)
...
"""
    ...
    for model in models_to_try:
        ...
        try:
            ...
            success = True
            print(f"Successfully enriched {name_vi} using model {model}!")
            break
    ...
    if success:
        ...
        print("ERROR: All Groq models failed to enrich Ngọ Môn.")
        sys.exit(1)
